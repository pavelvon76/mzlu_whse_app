page 50002 "Scann Whse. Item Journal MZLU"
{
    ...
    layout
    {
        area(content)
        {
            ...
            usercontrol(ScannerAddInControl; "ScannerTSX.ControlAddIn.MZLU")
            {
                ApplicationArea = all;
                ...
                var
                    ScannMgt: Codeunit "ScannerMgt.Codeunit.MZLU";
                begin

                    ScannMgt.FindScannedCode(Barcode, Rec);
        ...
        area(processing)
        {
            group("&Registering")
            {
                ...
                action("Scann DATA")
                {
                    ...
                    Ellipsis = true;
                    Caption = 'Scann DATA';
                    ToolTip = 'Initialize new warehouse - scann even';
                    Image = Warehouse;

                    trigger OnAction()
                    begin
                        SetUpNewLine(xRec);
                        ScannerMgtCodeunit.FindScannedCode('1906-S', Rec);
                    end;
                }
                action("Test Report")
                {
    ...
    var
        ...
        ScannerMgtCodeunit: Codeunit "ScannerMgt.Codeunit.MZLU";
